    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      ...
      <div className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <button onClick={async () => { try { const res = await fetch("/api/leads/sync", { method: "POST" }); const data = await res.json(); if (data.ok) toast(data.matched > 0 ? `Caught ${data.matched} replies` : "No new replies"); else toast(data.error || "Sync failed", "error"); } catch { toast("Sync failed", "error"); } }} className="px-4 py-2 text-xs font-medium text-neutral-600 dark:text-neutral-400 bg-neutral-100 dark:bg-neutral-800 hover:bg-neutral-200 dark:hover:bg-neutral-700 rounded-lg transition-all duration-200 cursor-pointer shrink-0 inline-flex items-center gap-1.5">
